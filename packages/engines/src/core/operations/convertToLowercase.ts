...
type IConvertToLowercaseOperationArgs = {
    TargetColumns: {
        value: IColumnTarget[];
    };
};
type IConvertToLowercaseBaseProgram = {
    variableName: string;
    columnKeys: string[];
};
 ...
 */
export const ConvertToLowercaseOperationBase: () => IGenericOperation<
    IConvertToLowercaseOperationArgs,
    IConvertToLowercaseBaseProgram,
            ...
            getDescription: (locale) =>
                ctx.formatString(
                    ctx.args.TargetColumns.value.length === 1
                        ? ctx.getLocalizedStrings(locale).OperationConvertToLowercaseDescription
                        : ctx.getLocalizedStrings(locale).OperationConvertToLowercaseDescriptionPlural,
